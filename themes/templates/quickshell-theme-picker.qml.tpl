    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: root.colorWithAlpha(root.chromeTheme.background, {{ quick_panel_opacity }})
                ...
                Column {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            color: root.colorWithAlpha(root.chromeTheme.surfaceHover, {{ quick_card_opacity }})
                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                Rectangle {
                                    ...
                                    color: root.colorWithAlpha(selected ? theme.surfaceHover : theme.surface, {{ quick_card_opacity }})
