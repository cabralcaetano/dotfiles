...
ShellRoot {
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            Rectangle {
                id: panel
                width: {{ quick_clock_width }}
                height: {{ quick_clock_height }}
                anchors.horizontalCenter: parent.horizontalCenter
                anchors.top: parent.top
                transform: Scale {
                    origin.x: panel.width / 2
                    origin.y: 0
                    xScale: {{ quick_clock_scale }}
                    yScale: {{ quick_clock_scale }}
                }
                anchors.topMargin: 0
                radius: {{ quick_panel_radius }}
                color: root.colorWithAlpha("{{ quick_panel_background }}", {{ quick_panel_opacity }})
                border.color: root.colorWithAlpha("{{ accent }}", 0.2)
                border.width: 1
                ...
                Column {
                    anchors.fill: parent
                    anchors.margins: {{ quick_clock_margin }}
                    spacing: {{ quick_clock_spacing }}
        ...
        Column {
            ...
            Row {
                ...
                ControlButton {
                    ...
                    buttonHeight: {{ quick_clock_control_height }}
                    label: "󰒮"
    ...
    component CalendarBox: Rectangle {
        ...
        height: {{ quick_clock_bottom_height }}
        radius: {{ quick_card_radius }}
        color: root.colorWithAlpha("{{ quick_card_background }}", {{ quick_card_opacity }})
        border.color: root.colorWithAlpha("{{ accent }}", 0.28)
        border.width: 1
        ...
        Column {
            ...
            Row {
                width: parent.width
                height: Math.max(16, {{ quick_clock_control_height }} - 10)
                spacing: 4
            ...
            Grid {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        height: {{ quick_card_radius }} === 0 ? 15 : 18
                        color: "transparent"

                        Rectangle {
                            anchors.centerIn: parent
                            width: {{ quick_card_radius }} === 0 ? 16 : 18
                            height: {{ quick_card_radius }} === 0 ? 15 : 18
                            radius: {{ quick_button_radius }}
                            color: modelData.today ? root.colorWithAlpha("{{ accent }}", 0.28) : "transparent"
                            border.color: root.colorWithAlpha("{{ accent }}", 0.28)
                        ...
                        Text {
                            ...
                            horizontalAlignment: Text.AlignHCenter
                            font.family: "JetBrainsMono Nerd Font"
                            font.pixelSize: {{ quick_card_radius }} === 0 ? 11 : 12
    ...
    component CalendarNavButton: Rectangle {
        ...
        width: 18
        height: {{ quick_card_radius }} === 0 ? 16 : 18
        radius: {{ quick_button_radius }}
        color: navArea.containsMouse ? root.colorWithAlpha("{{ quick_hover_background }}", {{ quick_hover_opacity }}) : "transparent"
        border.color: root.colorWithAlpha("{{ accent }}", 0.28)
        border.width: 1
    ...
    component ControlButton: Rectangle {
        ...
        height: buttonHeight
        radius: {{ quick_button_radius }}
        color: root.colorWithAlpha(clickArea.containsMouse ? "{{ quick_hover_background }}" : "{{ quick_card_background }}", clickArea.containsMouse ? {{ quick_hover_opacity }} : {{ quick_card_opacity }})
        border.color: root.colorWithAlpha("{{ accent }}", 0.28)
        border.width: 1
