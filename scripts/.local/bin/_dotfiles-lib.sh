...
STOW_PKGS=(hypr waybar quickshell swaync fuzzel fcitx5 scripts ghostty kitty btop zsh starship gtk-3 gtk-4 qt6ct wlogout nvim tmux networkmanager-dmenu neofetch claude xdg-desktop-portal xcompose chromium)
