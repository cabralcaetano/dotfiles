...
Alternância: clique no ícone de bateria na Waybar (`custom/battery-conservation`, ver [Waybar](#waybar)), ou no botão `󰓅` no painel SwayNC (`Super+N`). Ciclo: Balanceado → Balanceado+ → Performance → Economia → Super Economia → Balanceado.
